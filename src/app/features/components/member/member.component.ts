                    ...
                    this.userService
                        ...
                        .pipe(
                            tap(() => {
                                ...
                                this.findAllMember();
                                this.auditLogService.log('', 'Account', 'Delete', `User : ${member.username}, Email: ${member.email}`);
                            }),
                            catchError((error) => {
                                this.auditLogService.log('', 'Account', 'Delete', `Failed, User : ${member.username}, Email: ${member.email}`);
                                this.sweetalertService.handleError(error);
                                throw error;
                            }),
                        )
